...
huntflow.ru - это crm система для рекрутеров с удобными автофильтрами и автоматическим учетом прохождения кандидатов по этапам (этапов может быть много, вплоть до 7-10)\
